...
class WechatPay
{
    ...
    {
        $this->appid = !empty(config('wechat_appid')) ? config('wechat_appid') : '';
        $this->mch_id = !empty(config('wechat_direct_mchid')) ? config('wechat_direct_mchid') : '';
        $this->partnerKey = !empty(config('wechat_direct_partnerkey')) ? config('wechat_direct_partnerkey') : '';
