...
//        }
     ...
     * @return bool|string
     */
    public function getPrepayId($openid,$sub_mchid, $body, $out_trade_no, $total_fee, $notify_url, $trade_type = "JSAPI", $goods_tag = null, $fee_type = 'CNY',$sub_appid='',$sub_openid='')
    {
        $postdata = array(
            "sub_mch_id"       => $sub_mchid,
            "body"             => $body,
     ...
     * @return bool
     */
    public function refund($sub_mchid,$out_trade_no, $transaction_id, $out_refund_no, $total_fee, $refund_fee, $op_user_id = null, $refund_account = '')
    {
        $data = array();
     ...
     */
    public function sendRedPack($sub_mchid,$openid, $total_amount, $mch_billno, $sendname, $wishing, $act_name, $remark, $total_num = 1, $scene_id = null, $risk_info = '', $consume_mch_id = null)
    {
        $data = array();
        $data['sub_mch_id'] = $sub_mchid; 
